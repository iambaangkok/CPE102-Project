...
public: 
    ...
    void Update(float deltaTime,RenderWindow& window,unordered_map<string, bool>& mousePress, unordered_map<string, bool>& mouseHold, Vector2i& mousePosition, bool& quitGame, int& selectedPet);
    ...
    void OnHover();
    void OnHold();
    void OnRelease(bool& quitGame, int& selectedPet);
